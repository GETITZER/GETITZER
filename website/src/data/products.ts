    ...
    variants: [
      {
        ...
        color: '#ea580c',
        desc: 'Heavy-duty slurry and extreme abrasion resistant sleeve. The primary choice for high-solids slurry lines.',
        applications: ['Thickener Underflow', 'Tailings Lines', 'Mill Discharge'],
      },
      {
        name: 'ISA-Extrem™',
      ...
      },
      {
        ...
        applications: ['Exposed Tailings Lines', 'Open-Air Circuits', 'UV Exposed Zones'],
      },
      {
        name: 'ISA-Chem™',
        ...
        applications: ['CIL/CIP Circuits', 'Acid Wash Lines', 'Reagent Dosing'],
      },
    ],
    specs: [
      { label: 'Pressure Rating', value: 'PN16 (1600 kPa)' },
      { label: 'Flange Standards', value: 'SANS 1123 / BS10 / ANSI 150' },
      { label: 'Certification', value: 'ISO 5208 Grade A — Zero Leakage' },
      { label: 'Sleeve Grades', value: 'ISA-Flex™ / ISA-Extrem™ / ISA-Shield™ / ISA-Chem™' },
      { label: 'Actuation', value: 'Manual handwheel (std) / Pneumatic / Electric (optional)' },
      { label: 'Maintenance', value: 'Non-hydrocarbon lubrication only. Spare ratio: 1 per 3 units' },
      { label: 'Applications', value: 'Thickener underflow, cyclone feed, tailings lines, CIL/CIP' },
    ],
