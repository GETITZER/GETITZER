...
export const products: Product[] = [
  ...
  },
  {
    ...
    shortName: 'DXST KGV',
    tagline: 'Tier 3 — Extreme Abrasion · Natural Rubber Lined · 466% Longer Life',
    description:
      'The ISA DXST Series is engineered explicitly for the most severe high-wear mining conditions: thickener underflow, CIL circuits, and dense slurry lines where standard valves fail in under 3 months. Premium injection-moulded natural rubber lining with unrestricted straight-through bore delivers 466% longer service life.',
    useCase:
      'Specify the DXST Series when valve service life under 6 months is unacceptable. Proven to extend life from 3 months to 14 months in Northern Cape copper mining thickener underflow service.',
    icon: '🟢',
    badge: 'NEW · 466% LONGER LIFE',
    badgeColor: 'green',
    featured: true,
    highlights: [
      '466% increase in service life — 3 months to 14 months proven in copper mining',
      'Premium injection-moulded natural rubber lining (-10°C to 85°C)',
      'Unrestricted straight-through bore — minimal turbulence in abrasive media',
      'Precision-machined SS rising spindle with visual position indicator',
      'Cast iron body with multiple standard flange drillings (multi-standard)',
    ],
    specs: [
      { label: 'Application', value: 'Severe high-wear, thickener underflow, CIL circuits' },
      { label: 'Lining', value: '100% Premium Natural Rubber, injection-moulded' },
      { label: 'Temperature', value: '-10°C to +85°C operating range' },
      { label: 'Body', value: 'High-grade industrial cast iron, multi-standard flange drillings' },
      { label: 'Spindle', value: 'Precision-machined stainless steel, rising type with position indicator' },
      { label: 'Size Range', value: 'DN25–DN300, PN6–PN20 (contact for larger)' },
